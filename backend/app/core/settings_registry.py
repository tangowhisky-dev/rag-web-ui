...
_ORG_OVERRIDABLE = [
    ...
    SettingDef("VISION_MODEL", "LLM & Models", "Vision/OCR model",
               "str", None, scope="org", reload="next_request",
               description="Multimodal model for OCR. Org override applies to query-time only."),
    ...
    SettingDef("GRAPHRAG_LLM", "GraphRAG", "Graph extraction model",
               "str", None, scope="org", reload="next_request",
               description="Falls back to OPENAI_MODEL. Org override applies to query-time only."),

    # Retrieval tuning
    SettingDef("RETRIEVAL_TOP_K", "Retrieval", "Top-K",
               "int", 20, scope="org", reload="next_request", min_value=1, max_value=200),
    SettingDef("RETRIEVAL_MIN_RRF_SCORE", "Retrieval", "Min RRF score",
               "float", 0.005, scope="org", reload="next_request", min_value=0.0,
               description="Chunks below this RRF score are dropped. 0.0 disables."),
    ...
    SettingDef("TOOL_CALLING_ENABLED", "Agentic", "Enable tool calling",
               "bool", True, scope="org", reload="next_request"),
    SettingDef("MAX_TOOL_ITERATIONS", "Agentic", "Max tool iterations",
