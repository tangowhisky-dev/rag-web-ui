...
_ORG_OVERRIDABLE = [
    ...
    SettingDef("AGENT_MAX_SEARCH_EXACT", "Agentic", "Max keyword_search calls",
               "int", 5, scope="org", reload="next_request", min_value=0,
               description="Cap on keyword_search (MySQL FTS + SPLADE, merged) tool calls per turn."),
    SettingDef("AGENT_MAX_SEARCH_SPARSE", "Agentic", "Max search_sparse calls (unused)",
               "int", 5, scope="org", reload="next_request", min_value=0,
               description="Legacy setting. Merged into keyword_search. Kept for backward compatibility."),
    SettingDef("AGENT_MAX_SEARCH_DENSE", "Agentic", "Max semantic_search calls",
               "int", 5, scope="org", reload="next_request", min_value=0,
               description="Cap on semantic_search (semantic vector) tool calls per turn."),
    ...
    SettingDef("AGENT_MAX_KB_SEARCH", "Agentic", "Max title_search calls",
               "int", 10, scope="org", reload="next_request", min_value=0,
               description="Cap on title_search tool calls per turn."),
