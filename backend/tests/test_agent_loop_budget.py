...
def test_route_think_routes_to_tool_when_calls_present():
    ...
    with patch("app.services.agentic_rag.agent_graph_v2.thinking.get_setting", return_value=8):
...
def test_route_think_routes_to_post_process_at_max_iterations():
    ...
    with patch("app.services.agentic_rag.agent_graph_v2.thinking.get_setting", return_value=3):
...
def test_route_think_routes_to_post_process_when_no_calls():
    ...
    with patch("app.services.agentic_rag.agent_graph_v2.thinking.get_setting", return_value=5):
